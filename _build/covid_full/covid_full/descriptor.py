...
us_trends_page = {
    ...
    "layout": [["axis", "pick_state", "analytics", "window"], ["trend"], ["style"]],
    "connections": {
        "axis": {"trend"},
        "pick_state": {"trend"},
        "window": {"trend"},
...
data_page = {
    ...
    "layout": [["covid_world_table", "covid_table"]],
    "connections": {},
}
...
descriptor = {
    ...
    "data": {
        "covid_us": {"module": "covid_full.df_covid_us"},
        "covid_world": {"module": "covid_full.df_covid_world"},
    },
    "pages": {
        "globe": globe_page,
